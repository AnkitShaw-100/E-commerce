  ...
  const slides = [
    {
      ...
      preview:
        "https://images.unsplash.com/photo-1498049794561-7780e7231661?auto=format&fit=crop&w=800&q=80", // Electronics devices
    },
    {
      ...
      preview:
        "https://images.unsplash.com/photo-1445205170230-053b83016050?auto=format&fit=crop&w=800&q=80", // Fashion clothing
    },
    {
      ...
      preview:
        "https://images.unsplash.com/photo-1515377905703-c4788e51af15?auto=format&fit=crop&w=800&q=80", // Home decor
    },
  ];
              ...
              <div className="text-center lg:text-left text-white space-y-4">
                <div>
                  <div className="bg-black/30 rounded-2xl p-6 sm:p-8 lg:bg-transparent lg:p-0">
                    <h2 className="text-sm sm:text-base lg:text-lg font-semibold text-emerald-300 mb-2">
                      {slides[current].subtitle}
                    </h2>
                    <h1 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-extrabold mb-3 sm:mb-4 leading-tight">
                      {slides[current].title}
                    </h1>
                    <p className="text-xs sm:text-sm lg:text-base text-gray-200 mb-4 sm:mb-6 max-w-md mx-auto lg:mx-0">
                      {slides[current].desc}
                    </p>
                    <button
                      onClick={handleShopClick}
                      className="bg-gradient-to-r from-emerald-600 to-emerald-700 text-white font-semibold px-4 sm:px-6 py-2.5 sm:py-3 rounded-lg text-xs sm:text-sm lg:text-base"
                    >
                      {slides[current].cta}
                    </button>
                  </div>
                ...
                <div>
                  <div className="relative">
                    <img
                      ...
                      className="rounded-2xl w-[350px] h-[250px] lg:w-[400px] lg:h-[280px] object-cover border-4 border-white/40"
                    />
