      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="grid lg:grid-cols-2 gap-8 lg:gap-16 items-center mb-16 lg:mb-20">
          <div className="order-2 lg:order-1">
            <h2 className="text-3xl lg:text-4xl font-bold text-gray-900 mb-6 text-center lg:text-left">
              Our Story
            </h2>
            <p className="text-lg text-gray-700 mb-6 leading-relaxed">
              Founded with a vision to revolutionize online shopping, Apni Dukan
              was born from the idea that everyone deserves access to quality
              products at fair prices. We started as a small team with big
              dreams and have grown into a trusted platform serving thousands of
              customers.
            </p>
            <p className="text-lg text-gray-700 mb-6 leading-relaxed">
              Our journey began when we noticed the gap between customer
              expectations and what was available in the market. We decided to
              bridge that gap by curating products from trusted manufacturers
        ...
        <div className="mb-16 lg:mb-20">
          <div className="text-center mb-12 lg:mb-16">
            ...
            <p className="text-base lg:text-lg text-gray-700 max-w-3xl mx-auto leading-relaxed px-4">
              Behind Apni Dukan is a passionate team of professionals dedicated
              to making your shopping experience exceptional.
            </p>
          </div>
            ...
            <div className="order-1 lg:order-2">
              ...
              <div className="mt-8">
                ...
                <p className="text-gray-700 leading-relaxed">
                  ...
                  customer service, logistics, and product curation. We're
                  united by our shared mission to provide you with the best
        ...
        <div className="bg-gradient-to-r from-emerald-600 to-slate-700 rounded-2xl lg:rounded-3xl p-8 lg:p-12 text-center">
          ...
          <p className="text-lg lg:text-xl text-emerald-100 max-w-4xl mx-auto leading-relaxed mb-6 lg:mb-8 px-4">
            To democratize access to quality products by creating a platform
            where customers can discover, explore, and purchase items they love
